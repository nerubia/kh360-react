...
export const EvaluatorsRoles = () => {
  ...
  return (
    <div className='md:w-40 xl:w-80 md:h-[calc(100vh_-_185px)]pt-4 h-100 w-100'>
      <div className='flex-1 flex flex-col gap-2 overflow-y-scroll'>
        {evaluation_templates.map((template) => (
          <Menu
            ...
            className='w-full rounded-md flex items-center gap-2 text-black hover:bg-gray-100 active:bg-primary-500 [&.active]:bg-primary-500 [&.active]:text-white [&.active]:cursor-default h-7 lg:h-9 text-8 xl:text-base px-4'
          >
