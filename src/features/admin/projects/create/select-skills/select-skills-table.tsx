          ...
          <table className='w-full'>
            <thead className='text-left'>
              <tr>
                ...
                <th className='pb-3 px-3 w-1/4'>Name</th>
              </tr>
            </thead>
            <tbody>
              {skills.map((skill) => (
                <tr key={skill.id} className='hover:bg-slate-100'>
                  <td className='py-3 pr-3 w-1/12'>
                    <div>
                      <Checkbox
                  ...
                  <td className='py-3 px-3 w-1/4 whitespace-pre-line break-all'>
                    {skill.skill_categories.name}
                  </td>
                  <td className='py-3 prx-3 w-1/4 whitespace-pre-line break-all'>{skill.name}</td>
                </tr>
              ))}
            </tbody>
          </table>
