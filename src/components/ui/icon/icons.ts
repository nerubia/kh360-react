...
export const icons = {
  ...
  BrainCircuit: lazy(async () => await import("./icons/brain-circuit-icon")),
  ...
  Clipboard: lazy(async () => await import("./icons/clipboard-icon")),
  ClipboardList: lazy(async () => await import("./icons/clipboard-list-icon")),
  ...
  FileLineChart: lazy(async () => await import("./icons/file-line-chart-icon")),
  GanttChart: lazy(async () => await import("./icons/gantt-chart-icon")),
  Google: lazy(async () => await import("./icons/google-icon")),
  LineChart: lazy(async () => await import("./icons/line-chart-icon")),
  ...
  SearchCheck: lazy(async () => await import("./icons/search-check-icon")),
