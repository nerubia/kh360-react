...
test.describe("Admin - Preview Respondents", () => {
  ...
  test.describe("as Guest", () => {
    test("should not allow to view the admin preview respondents", async ({ page }) => {
      await page.goto("/admin/survey-administrations/1/preview")

      await expect(page).toHaveURL("/auth/login?callback=/admin/survey-administrations/1/preview")
    })
  })
  ...
  test.describe("as Admin", () => {
    test("should render correctly", async ({ page, isMobile }) => {
      ...
      await expect(page.getByRole("heading", { name: "Review Respondents" })).toBeVisible()
    ...
    test("should save and proceed succesfully", async ({ page, isMobile }) => {
      ...
      await mockRequest(page, "/admin/survey-results", {
        status: 200,
        contentType: "application/json",
        body: JSON.stringify({}),
      })
